    ...
    def onMessage(self, mid=None, author_id=None, message_object=None, thread_id=None, thread_type=ThreadType.USER, **kwargs):
        ...
        try:
            if("search pdf" in msg):
                ...
                sendMsg()
            elif ("what are you doing now " in msg or "kathai karai xi avi " in msg):
                reply = "nothing just chating with you hehe " in msg or " nai kuxo bas tora sathe chatting hehe")
                sendMsg()
